  ...
  return (
    <div className="container m-auto py-[96px]">
      <div className="flex justify-center">
        <a href="https://www.facebook.com/g.temka.620607">
          {" "}
      ...
      <div className="flex justify-center pt-[48px] flex-row gap-[20px]">
        ...
        <p className="md:text-[36px] text-[30px] font-[600]">
          <a href="https://www.youtube.com/watch?v=eUAlMh2jVCs&list=RDMMeUAlMh2jVCs&start_radio=1">
            Temuulen.mn
          </a>{" "}
        </p>
        <button>
